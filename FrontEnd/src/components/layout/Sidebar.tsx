...
const Sidebar = () => {
    ...
    const handleLogout = async () => {
        await logout();
        // Non-SuperAdmin users go to login page
        if (!isSuperAdmin) {
            router.push('/login');
        }
    };
    ...
    const mainMenuItems = [
        {
            ...
            roles: ['SUPERADMIN', 'ADMIN', 'USER'], // All roles can access dashboard
            path: '/dashboard'
        },
        {
            ...
            roles: ['SUPERADMIN', 'ADMIN', 'USER'], // All roles can review documents
            path: '/reviews'
        },
        {
            icon: <Bell size={20} />,
            ...
            roles: ['SUPERADMIN', 'ADMIN', 'USER'], // All roles can access notifications
            path: null,
        ...
        },
        {
            ...
            roles: ['SUPERADMIN', 'ADMIN'], // SUPERADMIN and ADMIN can manage
        ...
        },
        {
            ...
            roles: ['SUPERADMIN', 'ADMIN'], // SUPERADMIN and ADMIN can manage users
            path: '/manage-users'
        },
        {
            ...
            roles: ['SUPERADMIN', 'ADMIN', 'USER'], // All roles can access chat
            path: '/chatroom'
        },
        {
            ...
            roles: ['SUPERADMIN', 'ADMIN', 'USER'], // All roles can access settings
            path: '/settings'
        },
    ];
    ...
    const actionItems = [
        {
            ...
            roles: ['SUPERADMIN', 'ADMIN'], // SUPERADMIN and ADMIN can create workspaces
            path: null
        },
        {
                ...
                <div className="mt-auto pt-6 border-t border-zinc-200 dark:border-zinc-800 space-y-4">
                    ...
                    {isAuthenticated && user ? (
                        ...
                        <motion.button
                            ...
                            className="w-full flex items-center justify-center space-x-2 px-4 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-medium shadow-md transition-all duration-200"
                        >
