...
class ApiSettings(BaseSettings):
    ...
    def set_cors_origin_list(cls, cors_origin_list, info: FieldValidationInfo):
        ...
        # Add localhost:3000 to cors to allow requests from apcs_server (TypeScript backend).
        valid_cors.append("http://localhost:3000")
        # Add localhost:3001 to cors to allow requests from MicroHack frontend (Next.js).
